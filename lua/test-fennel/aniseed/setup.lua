...
local _2amodule_name_2a = "test-fennel.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("test-fennel.aniseed.core"), autoload("test-fennel.aniseed.env"), autoload("test-fennel.aniseed.eval"), autoload("test-fennel.aniseed.nvim")
