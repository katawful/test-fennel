...
local _2amodule_name_2a = "test-fennel.aniseed.fennel"
local _2amodule_2a
do
...
local autoload = (require("test-fennel.aniseed.autoload")).autoload
local a, fs, nvim, str = autoload("test-fennel.aniseed.core"), autoload("test-fennel.aniseed.fs"), autoload("test-fennel.aniseed.nvim"), autoload("test-fennel.aniseed.string")
...
local function impl()
  local compiler = require("test-fennel.aniseed.deps.fennel")
