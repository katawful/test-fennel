...
local _2amodule_name_2a = "test-fennel.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("test-fennel.aniseed.compile"), autoload("test-fennel.aniseed.fennel"), autoload("test-fennel.aniseed.fs"), autoload("test-fennel.aniseed.nvim")
