...
local _2amodule_name_2a = "test-fennel.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("test-fennel.aniseed.core"), autoload("test-fennel.aniseed.fennel"), autoload("test-fennel.aniseed.fs"), autoload("test-fennel.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "test-fennel.aniseed.macros"
  local filename
  do
