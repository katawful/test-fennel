...
local _2amodule_name_2a = "test-fennel.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("test-fennel.aniseed.core"), autoload("test-fennel.aniseed.compile"), autoload("test-fennel.aniseed.fennel"), autoload("test-fennel.aniseed.fs"), autoload("test-fennel.aniseed.nvim")
