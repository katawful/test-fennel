package.preload["test-fennel.aniseed.fennel.repl"] = package.preload["test-fennel.aniseed.fennel.repl"] or function(...)
  local utils = require("test-fennel.aniseed.fennel.utils")
  local parser = require("test-fennel.aniseed.fennel.parser")
  local compiler = require("test-fennel.aniseed.fennel.compiler")
  local specials = require("test-fennel.aniseed.fennel.specials")
  local view = require("test-fennel.aniseed.fennel.view")
...
package.preload["test-fennel.aniseed.fennel.specials"] = package.preload["test-fennel.aniseed.fennel.specials"] or function(...)
  local utils = require("test-fennel.aniseed.fennel.utils")
  local view = require("test-fennel.aniseed.fennel.view")
  local parser = require("test-fennel.aniseed.fennel.parser")
  local compiler = require("test-fennel.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "test-fennel.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["test-fennel.aniseed.fennel.compiler"] = package.preload["test-fennel.aniseed.fennel.compiler"] or function(...)
  local utils = require("test-fennel.aniseed.fennel.utils")
  local parser = require("test-fennel.aniseed.fennel.parser")
  local friend = require("test-fennel.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["test-fennel.aniseed.fennel.friend"] = package.preload["test-fennel.aniseed.fennel.friend"] or function(...)
  local utils = require("test-fennel.aniseed.fennel.utils")
...
package.preload["test-fennel.aniseed.fennel.parser"] = package.preload["test-fennel.aniseed.fennel.parser"] or function(...)
  local utils = require("test-fennel.aniseed.fennel.utils")
  local friend = require("test-fennel.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["test-fennel.aniseed.fennel.view"] = package.preload["test-fennel.aniseed.fennel.view"] or function(...)
...
package.preload["test-fennel.aniseed.fennel.utils"] = package.preload["test-fennel.aniseed.fennel.utils"] or function(...)
  local view = require("test-fennel.aniseed.fennel.view")
  local version = "1.1.0"
...
utils = require("test-fennel.aniseed.fennel.utils")
local parser = require("test-fennel.aniseed.fennel.parser")
local compiler = require("test-fennel.aniseed.fennel.compiler")
local specials = require("test-fennel.aniseed.fennel.specials")
local repl = require("test-fennel.aniseed.fennel.repl")
local view = require("test-fennel.aniseed.fennel.view")
...
do
  ...
  local module_name = "test-fennel.aniseed.fennel.macros"
  local _
